<?php
$pageTitle = 'Manage Driving Test Slots';
...
<div class="dashboard-layout">
    ...
    <div class="dashboard-content">
        <div class="container-fluid">
            <h2 class="mb-4">Manage Driving Test Slots</h2>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo BASE_URL; ?>/slot/createDriving" class="needs-validation" novalidate>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo BASE_URL; ?>/slot/driving" class="row g-3">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            ...
                            <a href="<?php echo BASE_URL; ?>/slot/driving" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-calendar-check"></i> Driving Test Slots (<?php echo count($slots); ?>)</h5>
                </div>
                <div class="card-body">
                    <?php if (empty($slots)): ?>
                                ...
                                <tbody>
                                    <?php foreach ($slots as $slot): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $slot['evaluator_name']; ?></td>
                                            <td>
                                                <span class="badge bg-secondary">
                                                    <?php echo ucfirst(str_replace('_', ' ', $slot['license_type'])); ?>
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="<?php echo BASE_URL; ?>/slot/toggleDriving/<?php echo $slot['slot_id']; ?>" 
                                                    ...
                                                    <?php if ($slot['current_bookings'] == 0): ?>
                                                        <a href="<?php echo BASE_URL; ?>/slot/deleteDriving/<?php echo $slot['slot_id']; ?>" 
