...
<div class="dashboard-layout">
    ...
    <div class="dashboard-content">
        <div class="container-fluid">
            <h2 class="mb-4">Medical Officer Dashboard</h2>
                ...
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-primary text-white">
                            <h5 class="mb-0"><i class="bi bi-calendar-event"></i> Scheduled Medical Evaluations</h5>
                        </div>
                        <div class="card-body">
                            <?php if (empty($scheduledEvaluations)): ?>
                                <div class="empty-state">
                                    <i class="bi bi-calendar-x"></i>
                                    <p>No scheduled evaluations</p>
                                </div>
                            <?php else: ?>
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php foreach ($scheduledEvaluations as $eval): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date('M d, Y', strtotime($eval['slot_date'])); ?></td>
                                                    <td><?php echo date('h:i A', strtotime($eval['slot_time'])); ?></td>
                                                    <td>
                                                        <a href="<?php echo BASE_URL; ?>/medical/evaluate/<?php echo $eval['application_id']; ?>" 
                                                           class="btn btn-sm btn-primary">
                                                            <i class="bi bi-clipboard-check"></i> Evaluate
                                                        </a>
                                                        <a href="<?php echo BASE_URL; ?>/application/view/<?php echo $eval['application_id']; ?>" 
                ...
                <div class="col-md-12">
                    <div class="card shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo BASE_URL; ?>/medical/list" class="btn btn-sm btn-primary">View All</a>
                        </div>
                        <div class="card-body">
